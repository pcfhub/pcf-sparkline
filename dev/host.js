...
(function (root, factory) {
    ...
    /*
     * The 1033 strings, so the harness page reads like the control does. A key
     * with no entry renders as the key itself, which is the tell that a string
     * reached the DOM without going through the .resx.
     */
    var STRINGS = {
        Sparkline_Name: 'Sparkline',
        Sparkline_Loading: 'Loading records…',
        Sparkline_Empty: 'No records to chart.',
        Sparkline_NoValueColumn: 'Bind a numeric column to Value to draw a chart.',
        Sparkline_NoNumbers: 'The bound column holds no numbers, so there is nothing to draw.',
        Sparkline_Error: 'The records could not be loaded.',
        Sparkline_Expand: 'Expand chart',
        Sparkline_Collapse: 'Collapse chart',
        Sparkline_PointsGroup: 'Chart points',
        Sparkline_PointOf: 'Point {0} of {1}',
        Sparkline_Readout: '{0}: {1}',
        Sparkline_SummaryLine: 'Line chart of {0}. {1} points, from {2} to {3}.',
        Sparkline_SummaryArea: 'Area chart of {0}. {1} points, from {2} to {3}.',
